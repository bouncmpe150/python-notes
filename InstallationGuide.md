...
* Version 2021.3.2 is compatible with our plugin. But, if you encounter any errors, try downgrading to version 2021.2.2. If you have other versions, please upgrade/downgrade to one of these versions.
...
* After the installation, run **PyCharm**. License Activation window will appear if you chose “*Professional*”. You can get a free student license with your university email (with the boun extension) from JetBrains here: https://www.jetbrains.com/community/education/#students. 
* Enter your license information and activate your license.
